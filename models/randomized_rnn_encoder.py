...
class DeepESNEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.input_scalings = nn.ParameterList()
        self.bias_scalings = nn.ParameterList()
        ...
        self.layers.append(nn.ModuleDict({
            ...
            'bias': nn.Parameter(torch.zeros(first_hidden_dim))
        }))
        ...
        for l in range(1, self.num_layers):
            ...
            self.layers.append(nn.ModuleDict({
                ...
                'bias': nn.Parameter(torch.zeros(curr_dim))
            }))
    ...
    def _initialize_esn_weights(
        ...
        for layer_idx, layer in enumerate(self.layers):
            ...
            # Initialize bias
            nn.init.uniform_(layer['bias'], -bias_scaling, bias_scaling)
